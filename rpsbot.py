    ...
    # human v. human
        ...
        for i in range(rounds):
            ...
            if verdict == "tie":
                ...
                await player1.send(f"You chose {player1_choice[0].emoji}, which beats {player2.name}'s {opponent_choice[0].emoji}.")
                ...
                await player1.send(f"You chose {player1_choice[0].emoji}, which loses to {player2.name}'s {opponent_choice[0].emoji}.")
